...
public class DeletedBlockLogStateManagerImplV2
  ...
  public static class Builder {
    ...
    public Builder setBatchOperationHandler(final BatchOperationHandler handler) {
    ...
    public DeletedBlockLogStateManagerV2 build() {
      ...
      final SCMHAInvocationHandler invocationHandler =
          new SCMHAInvocationHandler(SCMRatisProtocol.RequestType.DELETE_BLOCK, impl,
              scmRatisServer);

      return (DeletedBlockLogStateManagerV2) Proxy.newProxyInstance(
          SCMHAInvocationHandler.class.getClassLoader(),
          new Class<?>[]{DeletedBlockLogStateManagerV2.class}, invocationHandler);
    }
